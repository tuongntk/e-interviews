...
localStorage.getItem('docsTheme') == 'dark' && document.documentElement.setAttribute('data-color-theme', 'dark');
...
const App = function () {
    ...
    const layoutTheme = function() {
        ...
        function initTheme() {
            var darkThemeSelected = localStorage.getItem("docsTheme") !== null && localStorage.getItem("docsTheme") === "dark";
